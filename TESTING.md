...
Email Address field | If email without an `@` is entered into the field and the **Sign Up** button is clicked, the form does not submit and a validation message appears reminding the user of the correct email format.|Field left blank and **Sign Up** button clicked| The form did not submit and the validation message was displayed|Pass
Email Address field | If email without a domain after the `@` is entered into the field and the **Sign Up** button is clicked, the form does not submit and a validation message appears reminding the user of the correct email format.|Field left blank and **Sign Up** button clicked| The form did not submit and the validation message was displayed|Pass
...
Sign Up button | If all fields are completed correctly and the **Sign Up** button is clicked, the page is reloaded and a validation message is displayed stating that the password is entirely numeric.|Password consisting of just numbers entered and **Sign Up** button clicked| Page reloaded and the validation message was displayed|Pass
**Sign Out Page**| | | | 
